...
HD_PWD='C:/Users/Parnian/Documents/GitHub/fpga-sutech-1401/projectWateringSystem/projectWateringSystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WateringSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WateringSystem.tcl
