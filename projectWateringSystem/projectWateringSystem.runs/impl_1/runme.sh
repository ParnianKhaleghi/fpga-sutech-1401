...
HD_PWD='C:/Users/Parnian/Documents/GitHub/fpga-sutech-1401/projectWateringSystem/projectWateringSystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WateringSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WateringSystem.tcl -notrace
